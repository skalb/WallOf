(function() {
  ...
  this.jsonFlickrApi = function(data) {
    ...
    $('#main').bind("dragstop", function(event, ui) {
      var bottom_offset, c, left_offset, r, should_create, top_offset, _ref, _ref2, _ref3, _ref4, _ref5, _ref6;
      ...
      if (ui.offset.top < last_bottom_position) {
        ...
        for (r = _ref3 = last_bottom_offset + 1; _ref3 <= bottom_offset ? r <= bottom_offset : r >= bottom_offset; _ref3 <= bottom_offset ? r++ : r--) {
          for (c = last_left_offset, _ref4 = cols - 1 - last_left_offset; last_left_offset <= _ref4 ? c <= _ref4 : c >= _ref4; last_left_offset <= _ref4 ? c++ : c--) {
            pairs_to_fill.push({
              r: r,
              c: c
            });
