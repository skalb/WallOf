(function() {
  var cols, direction, is_loading, last_left_offset, last_left_position, last_top_offset, last_top_position, pairs_to_fill, rows, tags;
  ...
  this.jsonFlickrApi = function(data) {
    ...
    $('#main').bind("dragstop", function(event, ui) {
      var c, left_offset, r, should_create, top_offset, _ref, _ref2, _ref3, _ref4;
      ...
      if (ui.offset.left > last_left_position) {
        ...
        for (r = last_top_offset, _ref3 = rows - 1; last_top_offset <= _ref3 ? r <= _ref3 : r >= _ref3; last_top_offset <= _ref3 ? r++ : r--) {
          for (c = left_offset, _ref4 = last_left_offset - 1; left_offset <= _ref4 ? c <= _ref4 : c >= _ref4; left_offset <= _ref4 ? c++ : c--) {
            pairs_to_fill.push({
              r: r,
              c: c
            });
