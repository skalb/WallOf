(function() {
  var cols, is_loading, last_bottom_offset, last_bottom_position, last_left_offset, last_left_position, last_right_offset, last_right_position, last_top_offset, last_top_position, pairs_to_fill, rows, tags;
  ...
  this.jsonFlickrApi = function(data) {
    var i, photos, _fn, _ref;
    $('#main').draggable();
    $('#main').bind("dragstop", function(event, ui) {
      var bottom_offset, c, left_offset, r, right_offset, should_create, top_offset, _ref, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      ...
      if (ui.offset.top > last_top_position) {
        ...
        for (r = top_offset, _ref = last_top_offset - 1; top_offset <= _ref ? r <= _ref : r >= _ref; top_offset <= _ref ? r++ : r--) {
          for (c = last_left_offset, _ref2 = cols - 1 - last_left_offset; last_left_offset <= _ref2 ? c <= _ref2 : c >= _ref2; last_left_offset <= _ref2 ? c++ : c--) {
            pairs_to_fill.push({
              r: r,
              c: c
            });
      ...
      if (ui.offset.top < last_bottom_position) {
        ...
        for (r = _ref3 = last_bottom_offset + 1; _ref3 <= bottom_offset ? r <= bottom_offset : r >= bottom_offset; _ref3 <= bottom_offset ? r++ : r--) {
          for (c = last_left_offset, _ref4 = cols + last_left_offset; last_left_offset <= _ref4 ? c <= _ref4 : c >= _ref4; last_left_offset <= _ref4 ? c++ : c--) {
            pairs_to_fill.push({
              r: r,
              c: c
            });
      ...
      if (ui.offset.left > last_left_position) {
        ...
        for (r = last_top_offset, _ref5 = rows - 1 - last_top_offset; last_top_offset <= _ref5 ? r <= _ref5 : r >= _ref5; last_top_offset <= _ref5 ? r++ : r--) {
          for (c = left_offset, _ref6 = last_left_offset - 1; left_offset <= _ref6 ? c <= _ref6 : c >= _ref6; left_offset <= _ref6 ? c++ : c--) {
            pairs_to_fill.push({
              r: r,
              c: c
            });
      ...
      if (ui.offset.left < last_right_position) {
        ...
        for (r = last_top_offset, _ref7 = rows - last_top_offset; last_top_offset <= _ref7 ? r <= _ref7 : r >= _ref7; last_top_offset <= _ref7 ? r++ : r--) {
          for (c = _ref8 = last_right_offset + 1; _ref8 <= right_offset ? c <= right_offset : c >= right_offset; _ref8 <= right_offset ? c++ : c--) {
            pairs_to_fill.push({
              r: r,
              c: c
            });
